...
- Unsupported or non-meaningful Node-specific APIs and audit reason: exact Node `Readable` object-mode row chunks and exact Node `createBinlogStream` object/EventEmitter shape remain adapted or deferred as documented in `docs/divergences.md`.
